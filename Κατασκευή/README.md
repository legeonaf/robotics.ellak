...
Εκεί θα είναι οι άκρες των καλωδίων. αρχίζοντας απο εκεί κολλάμε τις άκρες τους με σιλικόνη κάθετα και συνεχίζουμε να κολλάμε το καλώδιο ακολουθόντας κατεύθυνση προς το Arduino (D3-D4, GND).
...
#### Καλοριφέρ
Το καλοριφέρ είναι φτιαγμένο απο ένα λεπτό ξύλινο παραλληλόγραμμο κουτί χωρίς πάτο. Μέσα κολλάμε ένα κόκκινο LED φωτάκι. Το καλοριφέρ θα τοποθετηθεί στον τοίχο Π4.  Κάνουμε μία τρύπα στον τοίχο, περνάμε απο μέσα τα καλώδια, τα συνδέουμε στο Arduino και  κολλάμε το καλοριφέρ με σιλικόνη στο Π4 (D13, GND).
